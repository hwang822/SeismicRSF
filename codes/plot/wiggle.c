...
int main(int argc, char* argv[])
{
    ...
    bool bView;
    if (!sf_getbool("view",&bView)) bView=false;    

    FILE *pltpf = NULL;
    char* output = sf_getstring("output");
    ...
    {
        char *cmd=NULL;
        asprintf(&cmd, "./sfpen < %s", output); 
sf_warning("cmd=%s",cmd);
